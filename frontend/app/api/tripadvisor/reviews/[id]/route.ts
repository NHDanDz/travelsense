...
export async function GET(
  ...
  try {
    ...
    console.log('Fetching reviews for TripAdvisor place:', id);
    ...
    const url = `https://api.content.tripadvisor.com/api/v1/location/${id}/reviews?key=${apiKey}&language=vi`;
    ...
    return NextResponse.json(
      { 
        error: 'Failed to fetch place reviews from TripAdvisor', 
